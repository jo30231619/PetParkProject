...
//		return response;
	...
	@Transactional(readOnly = true)
	public ContributorData retrieveContributoryById(Long contributorId) {
...
//Line 52 - reason being because we are just reading
//Line 56 - turn that List contributor entity to contributor data
//line 110 - create pet park object